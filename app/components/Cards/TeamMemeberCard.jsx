...
const TeamMemeberCard = (props) => {
  return (
    <Box sx={{ width: "100%", textAlign: "center", position: "relative" }}>
      ...
      <CardHeader
        subheader={<Typography variant="caption">{props.subheader}</Typography>}
        title={<Typography variant="subSubheading">{props.title}</Typography>}
      />
      <CardContent>
